    ...
    <div class="row mb-3">
        <div class="col-12 col-md-9 mb-3">
            <div class="row mb-3">
                <div class="col-12 mb-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <x-form.form-textarea name="desc" label="Opis produktu" placeholder="Opis produktu" />
                            ...
                            <div class="input-group mb-3">
                                <div class="form-floating">
                                    ...
                                    <label for="manufacturer" class="col-form-label">Producent</label>
                                    @error('') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <span class="input-group-text">{!! TooltipHelper::tooltipSettingsUrl(url('/manufacturers/create') , TooltipEnum::EMPTY) !!}</span>
                            </div>
                ...
                <div class="col-12 col-md-6 col-md-3 mb-3">
                    <div class="card card-custome">
                        <div class="card-header">
                            Cena zakupu
                        </div>
                ...
                <div class="col-12 col-md-6 col-md-3 mb-3">
                    ...
                    <div class="card card-custome">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group mb-3">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="ean13" name="ean13" placeholder="0">
                            ...
                            <div class="input-group mb-3">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="ean8" name="ean8" placeholder="0">
                            ...
                            <div class="input-group mb-3">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="ean128" name="ean128" placeholder="0">
                            ...
                            <div class="input-group mb-3">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="ean14" name="ean14" placeholder="0">
        ...
        <div class="col-12 col-md-3 mb-3">
            ...
            <div class="card mb-3 card-custome">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="file" name="mainPhoto" id="mainPhoto" class="form-control">
                        @error('mainPhoto') <span class="text-danger">{{ $message }}</span> @enderror
            ...
            <div class="card mb-3 card-custome">
                ...
                <div class="card-body">
                    ...
                    <input type="file" name="otherPhotos[]" id="otherPhotos" class="form-control" multiple>
                    @error('otherPhotos') <span class="text-danger">{{ $message }}</span> @enderror
